...
//    sprintf(fname, argv[1]);
    ...
    for(int iterCnt = 0 ; iterCnt < numberofRestarts ; iterCnt++){
        ...
        for(int i = 0 ; i < N ; i++){
            ...
            /*
            In simple substitution cipher, we had 26 characters to be mapped to 26 observation symbols.
            In Zodiac 408 cipher, we need to map 54 symbols to 26 characters.
            */
            if(elem % 54 == i)
                count++;
        }
